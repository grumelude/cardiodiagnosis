<div class="cardiodiagnosis-1-20-80-1" id="main-content" role="main">

	<div class="portlet-layout row-fluid first-row">
	...
	<div class="portlet-layout row-fluid second-row">
		...
		<div class="portlet-column portlet-column-last span9" id="column-4">
			$processor.processColumn("column-4", "portlet-column-content
			portlet-column-content-last")</div>
			
	</div>

	<div class="portlet-layout row-fluid last-row">
